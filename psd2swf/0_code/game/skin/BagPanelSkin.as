		...
		public static var skin:Object=
			{name:"BagPanel",type:"Container",x:0,y:0,width:361,height:457,
				...
				[
					...
					{name:"txtCopperBind",type:"Label",x:198,y:405,width:69,height:17,
					...
					{name:"myvipanniuContainer",type:"Container",x:282,y:151,width:79,height:246,
						...
						[
							...
							{name:"yuancgy",type:"Button",x:7,y:97,width:60,height:41,
								children:
								[
									{name:"yuancgy",type:"Label",x:5,y:3,width:52,height:38,
										normal:{x:0,y:0,width:52,height:38,content:"<font color='#ffffff'>远程购药\r</font>",format:{align:"left",bold:false,color:0xffffff,font:"SimSun",italic:false,leading:0,letterSpacing:0,size:12,underline:false}}
									},
									{name:"myScaleImage",type:"ScaleImage",x:0,y:0,width:60,height:22,top:4,right:4,bottom:4,left:4,
										normal:{link:"BagPanel.anniu1",x:0,y:0,width:60,height:22},
										over:{link:"BagPanel.anniu2",x:0,y:0,width:60,height:22},
					...
					{name:"diban",type:"ScaleImage",x:13,y:12,width:270,height:429,top:12,right:12,bottom:12,left:12,
						normal:{link:"BagPanel.diban",x:0,y:0,width:270,height:429}
					},
					{name:"dibanmoji",type:"ScaleImage",x:0,y:0,width:294,height:457,top:24,right:24,bottom:24,left:24,
